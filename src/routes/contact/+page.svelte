...
<main>
    <section class="text-seg">
        <p>I'm Maksiks, the wiz behind this place.<br>
            Want to suggest a few sites for the collection? Feel free!</p>
        <p>The best way to contact me is via email:<br>
            ...
            <TooltipText text={'maksiks.touch@gmail.com'}></TooltipText>
        </p>
        <p>The second best way to contact me is on Discord:<br>
            <svg aria-label="Discord icon" class="discord-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
            ...
            <TooltipText text={'@maksiks'}></TooltipText>
        </p>
        <p>Alternatively:</p>
        <ul class="socials">
            {#each socials as social (social.text)}
                <li class={`social so-${social.text.toLowerCase()} inline`}>
                    <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                    <a href={social.link} target="_blank" rel="noopener me">
...
<Footer fromContact={true}></Footer>
